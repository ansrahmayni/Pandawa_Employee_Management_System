...
<head>
    ...
    <script>
        function toggleAdditionalFields() {
            ...
            const dailyReport2Section = document.getElementById('daily_report_2_section');
    ...
    <form action="../proyek/add_project.php" method="POST" enctype="multipart/form-data">
        <div class="part1">
            ...
            <!-- File Laporan Keuangan -->
                <label for="file_laporan_keuangan">File Laporan Keuangan:</label>
                <input type="file" id="file_laporan_keuangan" name="file_laporan_keuangan" accept="application/pdf" class="pdf" required>
            ...
            <div class="form-group">
                ...
                <input type="file" id="file_daily_report" name="file_daily_report" accept="application/pdf" class="pdf2" required>
            </div>
        </div>
        ...
        <div class="part2">
            ...
            <div class="2">
                <!-- Daily Report 2, BA 2 dan Serah Terima 2, Hidden by Default -->
                <div id="daily_report_2_section" class="form-group hidden">
                    <label for="file_daily_report_2">Daily Report 2:</label>
                    <input type="file" id="file_daily_report_2" name="file_daily_report_2" accept="application/pdf" class="pdf2">
                </div>
                ...
                <div id="serah_terima_2_section" class="form-group hidden">
                    <label for="file_serah_terima_2">Serah Terima 2:</label>
